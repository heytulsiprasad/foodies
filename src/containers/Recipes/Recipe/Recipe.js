...
function Recipe(props) {
    ...
    //     food = (
    //         <div>
    //             <img src={recipe.strMealThumb} alt="Foodies" />
    //         </div>
    //     );
    // }
    ...
    let items = [];
    for (let i = 1; i <= 20; i++) {
        items.push(res[`strIngredient${i}`]);
    }
    ...
    let video = "https://www.youtube.com/embed/" + res.strYoutube.split("=")[1];
        ...
        <div className={props.expand}>
            <div className="container p-12">
                ...
                <div className="container px-6 mt-6 mb-12">
                    ...
                    <p className="text-lg text-gray-800 text-justify px-12 md:px-4 sm:px-0 my-4 py-6">
                        {rules.join(".")}
                    </p>
                </div>
                <div className={[classes.VideoContainer, "mx-auto"].join(" ")}>
                    <iframe
                        title={res.idMeal}
                        width="315"
                        height="560"
